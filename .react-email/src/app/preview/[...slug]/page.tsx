...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["index"]},{"slug":["cancelacion","cancelacion-dentro-del-plazo"]},{"slug":["cancelacion","cancelacion-fuera-del-plazo"]},{"slug":["cancelacion","index"]},{"slug":["planes","index"]},{"slug":["planes","mail-bienvenida-demo"]},{"slug":["planes","mail-configuracion-plan-por-parte-del-kam"]},{"slug":["planes","mail-finalizacion-demo-2"]},{"slug":["planes","mail-finalizacion-demo"]},{"slug":["planes","mail-no-se-proceso-tu-pago"]},{"slug":["planes","mail-no-se-proceso-tu-pago2"]},{"slug":["resena","index"]}]
  );
}